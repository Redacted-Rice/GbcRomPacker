...
public class UnconstrainedMoveBlock extends MovableBlock {
    ...
    public UnconstrainedMoveBlock(SegmentedByteBlock code, int priority, byte startBank,
            byte stopBank) {
    ...
    public SortedSet<PrioritizedBankRange> getAllowableBankPreferences() {
        ...
        toReturn.add(new PrioritizedBankRange(Integer.MAX_VALUE, (byte) 0,
                (byte) (RomConstants.NUMBER_OF_BANKS - 1)));
        return toReturn;
    }
}
